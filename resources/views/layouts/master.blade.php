            ...
            <ul class="nav menu">
                ...
                <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                    ...
                    <ul class="children collapse" id="sub-item-1">
                        <li><a class="" href="{{ url('/admin/all')}}">
                            <span class="fa fa-angle-right">&nbsp;</span> Data Pegawai <span class="label label-info">{{ App\TbPegawai::all()->count() }}</span>
                            </a></li>
                        <li><a class="" href="{{ url('/admin/guru')}}">
                            <span class="fa fa-angle-right">&nbsp;</span> Guru <span class="label label-info">{{ App\TbPegawai::where('keterangan', 'guru')->count() }}</span>
                            </a></li>
                        <li><a class="" href="{{ url('/admin/honorer')}}">
                            <span class="fa fa-angle-right">&nbsp;</span> Honorer <span class="label label-info">{{ App\TbPegawai::where('keterangan', 'honorer')->count() }}</span>
                            </a></li>
                    </ul>
                </li>
                @endif
                <li><a href="/admin/generate-qrcode"><em class="fa fa-clone">&nbsp;</em> Generate QR Code</a></li>
                <li><a href="/admin/generatelaporan"><em class="fa fa-clone">&nbsp;</em> Generate Laporan</a></li>
